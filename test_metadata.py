...
def test_metadata():
    ...
    batch_data = {
        ...
        'total_pages': 189,
        'files': [
            {'name': 'dm00105823-nucleo-f401re-user-manual.pdf', 'pages': 91, 'cost': 0.5359, 'cost_per_page': 0.0059, 'tokens': 3424316, 'final_size': '128KB'},
            {'name': 'stsw-spin002.pdf', 'pages': 4, 'cost': 0.0227, 'cost_per_page': 0.0057, 'tokens': 149154, 'final_size': '4KB'},
            {'name': 'um1724-stm32-nucleo64-boards.pdf', 'pages': 91, 'cost': 0.5355, 'cost_per_page': 0.0059, 'tokens': 3423665, 'final_size': '127KB'},
